...
Route::resource('/book', 'BookController')->middleware('level');

Route::resource('/categories', 'CategoriesController')->middleware('level');

Route::resource('/employees', 'EmployeesController')->middleware('level');

Route::resource('/positions', 'PositionsController')->middleware( 'level');

Route::resource('/users', 'UserController')->middleware( 'level');
...
Route::group(['prefix' => 'cart', 'as' => 'cart.', 'middleware' => 'level'], function () {
...
Route::group(['prefix' => 'user', 'as' => 'user.', 'middleware' => 'level'], function() {
...
Route::group(['prefix' => 'order', 'as' => 'order.', 'middleware' => 'level'], function () {
